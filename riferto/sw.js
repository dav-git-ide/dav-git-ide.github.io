const CACHE='riferto-v0.10.1';
const STATIC=['./styles.css?v=0.10.1','./pin-guard.js?v=0.10.1','./ui-nav.js?v=0.10.1','./bootstrap.js?v=0.10.1','./setup-security.js?v=0.10.1','./app.js?v=0.10.1','./biometric.js?v=0.10.1','./credential-ui.js?v=0.10.1','./storage-backup.js?v=0.10.1','./manifest.webmanifest?v=0.10.1','./loinc-common.json'];
