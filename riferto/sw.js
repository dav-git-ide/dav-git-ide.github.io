const CACHE='riferto-v0.7.2';
const STATIC=['./styles.css?v=0.7.2','./pin-guard.js?v=0.7.2','./bootstrap.js?v=0.7.2','./app.js?v=0.7.2','./biometric.js?v=0.7.2','./manifest.webmanifest?v=0.7.2','./loinc-common.json'];
