const CACHE='riferto-v0.11.1';
const STATIC=['./styles.css?v=0.11.1','./pin-guard.js?v=0.11.1','./ui-nav.js?v=0.11.1','./bootstrap.js?v=0.11.1','./setup-security.js?v=0.11.1','./app.js?v=0.11.1','./biometric.js?v=0.11.1','./credential-ui.js?v=0.11.1','./storage-backup.js?v=0.11.1','./backup-guard.js?v=0.11.1','./loinc-search.js?v=0.11.1','./reports-search.js?v=0.11.1','./manifest.webmanifest?v=0.11.1','./loinc-common.json'];
