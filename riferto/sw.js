const CACHE='riferto-v0.10.0';
const STATIC=['./styles.css?v=0.10.0','./pin-guard.js?v=0.10.0','./ui-nav.js?v=0.10.0','./bootstrap.js?v=0.10.0','./setup-security.js?v=0.10.0','./app.js?v=0.10.0','./biometric.js?v=0.10.0','./credential-ui.js?v=0.10.0','./storage-backup.js?v=0.10.0','./manifest.webmanifest?v=0.10.0','./loinc-common.json'];
