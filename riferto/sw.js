const CACHE='riferto-v0.8.0';
const STATIC=['./styles.css?v=0.8.0','./pin-guard.js?v=0.8.0','./ui-nav.js?v=0.8.0','./bootstrap.js?v=0.8.0','./app.js?v=0.8.0','./biometric.js?v=0.8.0','./manifest.webmanifest?v=0.8.0','./loinc-common.json'];
