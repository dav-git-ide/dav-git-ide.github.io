const CACHE='riferto-v0.10.3';
const STATIC=['./styles.css?v=0.10.3','./pin-guard.js?v=0.10.3','./ui-nav.js?v=0.10.3','./bootstrap.js?v=0.10.3','./setup-security.js?v=0.10.3','./app.js?v=0.10.3','./biometric.js?v=0.10.3','./credential-ui.js?v=0.10.3','./storage-backup.js?v=0.10.3','./backup-guard.js?v=0.10.3','./manifest.webmanifest?v=0.10.3','./loinc-common.json'];
