const CACHE='riferto-v0.8.1';
const STATIC=['./styles.css?v=0.8.1','./pin-guard.js?v=0.8.1','./ui-nav.js?v=0.8.1','./bootstrap.js?v=0.8.1','./app.js?v=0.8.1','./biometric.js?v=0.8.1','./manifest.webmanifest?v=0.8.1','./loinc-common.json'];
